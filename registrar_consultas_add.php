                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Registrar Consultas</h3><br>
                                    ...
                                    <form action="registrar_consultas_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        <div class="box-body">
                                            ...
                                            <label class="col-lg-2 control-label">Tratamiento</label>
                                                <div class="col-lg-8">
                                                    <textarea type="description" placeholder="El paciente presenta un cuadro gripal..." class="form-control" name="tratamiento" required autofocus></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            <input type="hidden" name="accion" value="1">
                                            <label class="col-lg-2 control-label">Observaciones</label>
                                                <div class="col-lg-8">
                                                    <textarea type="description" placeholder="El paciente presenta un cuadro gripal..." class="form-control" name="observaciones" required autofocus></textarea>
                                                </div>
                                            </div>
                                    </div>
