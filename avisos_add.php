                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Registro de Avisos / Recordatorios</h3><br>
                                    ...
                                    <form action="avisos_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        <div class="box-body">
                                            ...
                                            <label class="col-lg-2 control-label">Mensaje</label>
                                                <div class="col-lg-3">
                                                    <textarea type="description" placeholder="Su cita es en fecha 14/01/2025" class="form-control" name="mensaje" required autofocus></textarea>
                                                </div>
                                            <input type="hidden" name="accion" value="1">
