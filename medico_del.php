                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Borrar Médicos</h3>
                                        <div class="box-tools">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="id_medico" value="<?php echo $resultado[0]['id_medico'];?>" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="especialidad" value="<?php echo $resultado[0]['especialidad'];?>" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
