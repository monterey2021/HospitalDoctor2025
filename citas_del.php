                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Borrar Citas</h3>
                                        <div class="box-tools">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="date" class="form-control" name="fecha" value="<?php echo $resultado[0]['fecha'];?>" disabled>
                                                    <input type="hidden" name="hora" value="<?php echo $resultado[0]['id_cita']?>">
                                                    <input type="time" class="form-control" name="hora" value="<?php echo $resultado[0]['hora'];?>" disabled>
                                                </div>
                                                <label class="col-lg-2 control-label">Sucursal</label>
                                                <div class="col-lg-3">
                                                    <input type="hidden" name="accion" value="3">
                                                    <input type="hidden" name="nombresuc" value="<?php echo $resultado[0]['id_cita']?>">
                                                    <input type="text" class="form-control" name="nombresuc" value="<?php echo $resultado[0]['nombre_sucursal'];?>" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
