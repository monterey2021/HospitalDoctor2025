                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="id_sucursal" value="<?php echo $resultado[0]['id_sucursal'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="ciudad" value="<?php echo $resultado[0]['ciudad'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="pais" value="<?php echo $resultado[0]['país'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="numb" class="form-control" name="postal" value="<?php echo $resultado[0]['código_postal'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="numb" class="form-control" name="telefono" value="<?php echo $resultado[0]['teléfono'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
