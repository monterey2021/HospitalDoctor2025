                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Editar Consultas</h3>
                                        <div class="box-tools">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" name="id_consulta" value="<?php echo $resultado[0]['id_consulta'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">Tratamiento</label>
                                                    ...
                                                    <input type="description" class="form-control" name="tratamiento" value="<?php echo $resultado[0]['tratamiento'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">Observaciones</label>
                                                    ...
                                                    <input type="description" class="form-control" name="observaciones" value="<?php echo $resultado[0]['observaciones'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
