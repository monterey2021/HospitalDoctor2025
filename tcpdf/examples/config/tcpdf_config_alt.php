 ...
 */
define ('PDF_HEADER_LOGO', 'acceso.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'MARTIN');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'MARTIN REYES');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'AGENDA MEDICA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by MARTIN REYES");
