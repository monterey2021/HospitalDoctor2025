                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Editar Agenda Médica</h3>
                                        <div class="box-tools">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" name="id_agenda" value="<?php echo $resultado[0]['id_agenda'];?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="form-control" name="nombrepaci" required autofocus>
                                                        <option value=""><?php echo $resultado[0]['nombre_paciente'];?></option>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="form-control" name="nombremedi" required autofocus>
                                                        <option value=""><?php echo $resultado[0]['nombre_medico'];?></option>
